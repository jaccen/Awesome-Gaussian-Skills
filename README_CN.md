...
### 最全的 3D Gaussian Splatting 目录 — 819+ 方法，23 类别，交互式浏览器
...
[![Methods](https://img.shields.io/badge/方法-819+-9cf.svg)](references/3dgs-methods-overview.md)
...
秒搜 819+ 方法，按类别筛选，按引用排序，点击任意方法卡片查看详情。
...
**全书 12 章，每个方法名均锚定本仓库真实数据（819+ 方法、23 类别、15 技能），零虚构：**

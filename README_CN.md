...
- **领域专家知识**：内置知识库覆盖 31 个类别的 105+ 3DGS 变体，含领域术语规范
...
│       └── SKILL.md
├── references/
│   └── 3dgs-methods-overview.md # 内置知识库（105+ 方法）
├── scripts/
│   └── setup.sh                 # 快速安装脚本
├── README.md
├── README_CN.md
...
> 完整知识库覆盖 **31 个类别的 105+ 方法**的详细技术分析。详见 [`references/3dgs-methods-overview.md`](references/3dgs-methods-overview.md)。

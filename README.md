...
### The Most Comprehensive 3D Gaussian Splatting Catalog — 739+ Methods, 25 Categories, Interactive Explorer
...
[![Methods](https://img.shields.io/badge/Methods-739+-9cf.svg)](references/3dgs-methods-overview.md)
...
## Knowledge Base (739+ Methods, 25 Categories)
...
> Derived from systematic gap analysis across 739+ methods.
...
- [x] v0.3 — Knowledge base 675->739+ methods, 25 categories, 101+ bug patterns, 12 skills (Jun 2026)
...
├── references/                # Knowledge base (739+ methods, 25 categories)

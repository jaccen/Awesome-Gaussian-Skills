...
### The Most Comprehensive 3D Gaussian Splatting Catalog — 700+ Methods, 25 Categories, Interactive Explorer
...
[![Methods](https://img.shields.io/badge/Methods-700+-9cf.svg)](references/3dgs-methods-overview.md)
...
Search 700+ methods instantly, filter by category, sort by citations, click any method card for details.

## What's New (July 2026)

Latest update (Jul 2): **v0.4.0 — Router Architecture Expansion**. cg-paper-writing (657→110+7 fragments) and 3dgs-engineering-guide (459→95+7 fragments) refactored to Router + manifest.yaml + static/ architecture. 3dgs-code-reviewer v2.0.0 adds mandatory Self-Check Loop (SC-1~SC-4). cg-paper-writing adds Stage Gates (SG-1/2/3). Now 3 Router skills total, all 13 skills with anti-hallucination guardrails, 6 with Red Lines.
...
## Knowledge Base (700+ Methods, 25 Categories)
...
> Derived from systematic gap analysis across 700+ methods.
...
- [x] v0.3 — Knowledge base 675->700+ methods, 25 categories, 101+ bug patterns, 12 skills (Jun 2026)
- [x] v0.3.7 — Spatial intelligence wave: 680->700+ methods, +10 new methods (FastGS, Holi-Spatial, Spatial-TTT, etc.), Dimension 11, Anthropic standard alignment (Jun 25, 2026)
- [x] v0.3.7 — CVPR 2026 representative papers: 690->700+ methods, +23 verified new methods, all 13 skills updated (Jun 28, 2026)
...
├── references/                # Knowledge base (700+ methods, 25 categories)

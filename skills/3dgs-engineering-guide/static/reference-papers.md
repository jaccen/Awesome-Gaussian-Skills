...
| Relighting | GS³, GaRe, SSD-GS, LumiMotion, GOR-IS, **Ambient-Robust Inverse Rendering** [2605.30250], **InvSplat** [arXiv:2607.02301] (inverse feed-forward with intrinsic PBR), **MGM** [arXiv:2509.22112] (relightable 3D generation via multiview material diffusion) |
...
| Security | GuardMarkGS (watermarking + edit deterrence), **GaussTrace** [arXiv:2606.10612] (ICML 2026, 3DGS provenance analysis via LLM reasoning, IP protection & forensics) |
| Hardware | **Axis-Shared Rasterization Accelerator** (ISCA 2026, first 3DGS hardware accelerator), **StereoGS** (2026, energy-efficient stereoscopic 3DGS processor, dual-eye shared compute for VR/AR) |
| Robustness / Physics | **DualPhys-GS** [arXiv:2508.09610] (dual physically-guided underwater 3DGS, attenuation-scattering physics + lighting decomposition) |

...
| **Awesome-Gaussian-Skills** | (local project) | — | [github.com user project] | **[VERIFIED — LOCAL]** The current project: 678+ methods, 23 categories, 15 Agent Skills, MCP protocol integration. Comprehensive 3DGS/CAD/Mesh knowledge base for AI agents. |

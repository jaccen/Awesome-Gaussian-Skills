...
### The Most Comprehensive 3D Gaussian Splatting Catalog — 713+ Methods, 25 Categories, Interactive Explorer
...
[![Methods](https://img.shields.io/badge/Methods-713+-9cf.svg)](references/3dgs-methods-overview.md)
...
Latest update (Jun 28): 690->713+ methods, 25 categories, 101+ bug patterns. **CVPR 2026 representative papers wave**: +**Eulerian GS** (CVPR 2026, gradient-optimized densification), +**Energy-GS** (CVPR 2026 Oral, RGB-only joint optimization), +**NG-GS** (CVPR 2026 Highlight, NeRF-guided segmentation), +**UniSHARP** (CVPR 2026, unified omni-directional 3DGS), +**RAF** (CVPR 2026 Findings, physics engine bridge), +**PDEO** (CVPR 2026, PDE optimizer), +**Liquid Neural Fields** (continuous-time dynamic), +**MaterialClusterGS** (palette-based BRDF), +**Hand-4DGS** (egocentric 4D hand), +**GaussianPile** (volumetric 3DGS for MRI), +**ProGS** (45× compression), +**BlitzGS** (distributed city-scale). 23 verified methods added. Skills v0.3.7: all 13 skills updated.
...
## Knowledge Base (713+ Methods, 25 Categories)
...
- [x] v0.3.6 — Spatial intelligence wave: 680->690+ methods, +10 new methods (FastGS, Holi-Spatial, Spatial-TTT, etc.), Dimension 11, Anthropic standard alignment (Jun 25, 2026)
- [x] v0.3.7 — CVPR 2026 representative papers: 690->713+ methods, +23 verified new methods (Eulerian GS, Energy-GS, NG-GS, UniSHARP, RAF, PDEO, Liquid Neural Fields, MaterialClusterGS, etc.), all 13 skills updated (Jun 28, 2026)

(function () {
  var I18N = {
    zh: {
      ...
      "hero.version": "v0.9.5 · 现已开源",
      "hero.sub": "面向 3D Gaussian Splatting 与计算机图形学的空间智能开源工具箱",
      "hero.badge.methods": "872 方法", "hero.badge.cats": "23 个分类", "hero.badge.skills": "16 项技能",
      "hero.cta.methods": "探索方法", "hero.cta.book": "阅读电子书",
      "hero.studio": "SplatVerse Studio →", "hero.star": "在 GitHub 上 Star →",
      "hero.cta.studio": "进入工作台",
      "home.card.methods.t": "方法库", "home.card.methods.d": "872+ 个 3DGS 方法、23 个分类 — 搜索、筛选、对比，一键直达论文与代码。",
      ...
      "t2w.f2t": "智能方法选择", "t2w.f2d": "分析 872+ 3DGS 方法 — 自动为你挑选最优方案。",
      ...
      "methods.sub": "浏览 872 个方法、横跨 23 个分类 — 搜索、筛选、排序，点击任意卡片查看详情。",
    ...
    en: {
      ...
      "hero.version": "v0.9.5 · Open Source",
      "hero.sub": "3D Spatial Intelligence Open-Source Toolbox for 3D Gaussian Splatting & Computer Graphics",
      "hero.badge.methods": "872+ Methods", "hero.badge.cats": "23 Categories", "hero.badge.skills": "16 Skills",
      ...
      "home.card.methods.t": "Method Library", "home.card.methods.d": "872+ 3DGS methods across 23 categories — search, filter, compare; one click to papers & code.",
      ...
      "t2w.f2t": "Smart Method Selection", "t2w.f2d": "872+ 3DGS methods analyzed — best one auto-picked for you.",
      ...
      "methods.sub": "Browse 872 methods across 23 categories — search, filter, sort, and click any card for details.",
